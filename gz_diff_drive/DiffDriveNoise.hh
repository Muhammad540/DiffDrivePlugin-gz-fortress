...
namespace systems
{
  ...
  {
    /// \brief Constructor
    public: DiffDriveNoise();

    /// \brief Destructor
    public: ~DiffDriveNoise() override = default;
    ...
    private: std::unique_ptr<DiffDriveNoisePrivate> dataPtr;
  };
  }
}
}
